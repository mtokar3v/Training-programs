...
namespace The_2nd_project
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Stack<IProduct> products = new Stack<IProduct>();
        ...
        static void Del(ref Stack<IProduct> products, int i)
        {
            Stack<IProduct> NewProducts = new Stack<IProduct>();
            int count = 0;
        ...
        static void Change(ref Stack<IProduct> products, int i)
        {
            Stack<IProduct> NewProducts = new Stack<IProduct>();
            int count = 0;
            string choise = string.Empty;
        ...
        static void PrintProductFromCountry(Stack<IProduct> products, string name)
        {
        ...
        static void PrintMinProductFromCountry(Stack<IProduct> products, string country)
        {
        ...
        static void PrintAllProducts(Stack<IProduct> products)
        {
